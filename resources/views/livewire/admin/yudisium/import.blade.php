@section('title', 'Import Yudisium — ' . config('app.name'))
@section('header_title', 'Import Yudisium')
@section('header_subtitle', 'Import data yudisium mahasiswa secara massal dari file Excel')
...
@section('page_actions')
    <a
        href="{{ route('admin.akademik.yudisium') }}"
...
<div>
    <div class="mb-6 rounded-2xl bg-white p-6 shadow-border">
        ...
        <ol class="list-inside list-decimal space-y-1 text-sm text-neutral-600">
            ...
            <li>NIM harus sudah terdaftar sebagai mahasiswa, dan Jenis Keluar harus sama persis dengan salah satu data Jenis Keluar yang ada di sistem.</li>
            <li>Satu mahasiswa tidak boleh punya dua data yudisium dengan Jenis Keluar yang sama — baris seperti itu akan dilaporkan sebagai error, bukan diperbarui (modul ini tidak mendukung ubah/hapus lewat import).</li>
            <li>Tanggal Keluar, No. Ijazah, No. SK Yudisium, Tanggal SK Yudisium, IPK, Judul Skripsi/TA, dan Keterangan semuanya opsional. IPK harus di antara 0 dan 4.00 kalau diisi.</li>
