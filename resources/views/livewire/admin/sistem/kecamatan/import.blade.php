@section('title', 'Import Kecamatan — ' . config('app.name'))
@section('header_title', 'Import Kecamatan')
@section('header_subtitle', 'Import data kecamatan secara massal dari file Excel')
...
@section('page_actions')
    <a
        href="{{ route('admin.sistem.kecamatan') }}"
...
<div>
    <div class="mb-6 rounded-2xl bg-white p-6 shadow-border">
        ...
        <ol class="list-inside list-decimal space-y-1 text-sm text-neutral-600">
            ...
            <li>Isi data mengikuti kolom pada baris pertama (Kode, Nama, Kode Kota) — ketiganya wajib diisi.</li>
            <li>Kode Kota harus sudah ada di sistem (dicocokkan lewat kode kota).</li>
            <li>Kode kecamatan harus unik; baris dengan kode yang sudah ada di sistem akan diabaikan.</li>
