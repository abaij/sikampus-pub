@section('title', 'Import Kota — ' . config('app.name'))
@section('header_title', 'Import Kota')
@section('header_subtitle', 'Import data kota secara massal dari file Excel')
...
<div>
    <div class="mb-6 rounded-2xl bg-white p-6 shadow-border">
        ...
        <ol class="list-inside list-decimal space-y-1 text-sm text-neutral-600">
            ...
            <li>Isi data mengikuti kolom pada baris pertama (Kode, Nama, Kode Provinsi) — ketiganya wajib diisi.</li>
            <li>Kode Provinsi harus sudah ada di sistem (dicocokkan lewat kode provinsi).</li>
            <li>Kode kota harus unik; baris dengan kode yang sudah ada di sistem akan diabaikan.</li>
