@section('title', 'Import Provinsi — ' . config('app.name'))
@section('header_title', 'Import Provinsi')
@section('header_subtitle', 'Import data provinsi secara massal dari file Excel')
...
@section('breadcrumb')
    @include('admin.partials.breadcrumb', ['items' => [
        ['label' => 'Pengaturan'],
        ['label' => 'Sistem'],
        ['label' => 'Provinsi', 'route' => route('admin.sistem.provinsi')],
        ['label' => 'Import'],
    ]])
@endsection
...
@section('page_actions')
    <a
        href="{{ route('admin.sistem.provinsi') }}"
...
<div>
    <div class="mb-6 rounded-2xl bg-white p-6 shadow-border">
        ...
        <ol class="list-inside list-decimal space-y-1 text-sm text-neutral-600">
            ...
            <li>Isi data mengikuti kolom pada baris pertama (Kode, Nama, Kode Negara) — ketiganya wajib diisi.</li>
            <li>Kode Negara harus sudah ada di sistem (dicocokkan lewat kode negara).</li>
            <li>Kode provinsi harus unik; baris dengan kode yang sudah ada di sistem akan diabaikan.</li>
