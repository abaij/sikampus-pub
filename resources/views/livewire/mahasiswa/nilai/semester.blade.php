...
{{-- Judul sengaja dirender di dalam elemen root komponen, bukan lewat @section('header_title')
...
<div class="space-y-6">
    <div class="flex flex-wrap items-start justify-between gap-4">
        <div class="min-w-0">
            <h1 class="truncate text-2xl font-semibold tracking-tight text-neutral-900">Nilai Semester</h1>
        </div>
